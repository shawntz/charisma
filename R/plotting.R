...
plot_props <- function(
  ...
  freq_bar <- barplot(
    height = cluster_specific_hex_vals$prop,
    xaxt = "n",
    col = bar_colors,
    main = paste0(
      "Color Profile (k = ",
...
plot_pavo_pal <- function(
  ...
  image(
    seq_along(col_palette),
    1,
    as.matrix(seq_along(col_palette)),
    col = col_palette,
