...
For specialized image datasets, you may need custom color boundaries beyond the default CLUT. Use `launch_clut_editor()` to open an interactive web-based editor where you can visually create and test custom color definitions.
