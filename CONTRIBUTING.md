...
Thank you for your interest in contributing to `charisma`! This document
...
- Use the [bug report
  template](https://shawnschwartz.com/charisma/ISSUE_TEMPLATE/bug_report.md)
...
- Use the [feature request
  template](https://shawnschwartz.com/charisma/ISSUE_TEMPLATE/feature_request.md)
  when opening an issue
